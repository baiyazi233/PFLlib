...
# 加载第一个文件的数据
# with h5py.File('MNIST_FedADC_test_LeNet_200r_50d_4n.h5', 'r') as f1:
#     test_acc1 = f1['rs_test_acc'][:]

# # 加载第二个文件的数据
# with h5py.File('MNIST_FedAC_test_LeNet_200r_50d_4n.h5', 'r') as f2:
#     test_acc2 = f2['rs_test_acc'][:]

# # 加载第一个文件的数据
with h5py.File('Cifar10_FedADC_test_LeNet_200r_50d_4n.h5', 'r') as f1:
    test_acc1 = f1['rs_test_acc'][:]

# 加载第二个文件的数据
with h5py.File('Cifar10_FedAC_test_LeNet_200r_50d_4n.h5', 'r') as f2:
    test_acc2 = f2['rs_test_acc'][:]
...
# plt.title('Performance Comparison of Different Federated Learning Methods on MNIST with n = 4')
